...
\item Let $c_1,\cdots,c_{2g}$ be a set of disjoint nonseparating arcs in $\Sigma_3$ with their boundaries lying on the puncture of $\Sigma_3$ that is tubed to $\Sigma_1$.
