...
We can connect these two points with an arc of $D_{\alpha_i}$ in $(H_1 - B_{24}) \cap H_2 = M_x \cap X_1 \cap X_2$ and an arc of $D_{\beta_i}$ in $B_{24} \cap (H_1 - B_{24}) = M_x \cap X_1 \cap X_3$.
