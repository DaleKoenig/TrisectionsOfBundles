...
$I_{23} \times M$ induces a different identification between $M_{3/4}$ and $M_{1/4}$ by the automorphism $\varphi$, and this identification restricts to give an identification of $\Sigma_3$ and $\Sigma_1$ by $\varphi$.
...
We embed such that that rotating $\Sigma_1$ by $2\pi/3$ and then reflecting induces the natural identification (induced by induced by $[1/4,3/4] \times M$) between $\Sigma_1$ and $\Sigma_2$.
Similarly rotating $\Sigma_1$ by $4\pi/3$ (no reflection) gives the same identification between $\Sigma_1$ and $\Sigma_3$ as the natural identification induced by $[1/4,3/4] \times M$.
The identification between $\Sigma_1$ and $\Sigma_3$ induced by $I_{23} \times M$ (and therefore by $\varphi$) may be significantly more complicated, but by construction identifies the puncture $\{3/4\} \times \del B_{23} \subset \Sigma_3$ with the puncture $\{1/4\} \times \del B_{23} \subset \Sigma_1$.
...
Draw $2g$ disjoint nonseparating $\gamma$ curves by connecting up each $c_i$ with $\varphi(c_i)$ using two arcs in the tube between $\Sigma_1$ and $\Sigma_3$.
...
This ensures that the curves bounding product disks in the copies of $I_{ij} \times (\Sigma - D^2)$ are symmetric except for $I_{13} \times (\Sigma - D^2)$.
In the case of $I_{13} \times (\Sigma - D^2)$ the monodromy determines which arc in $\Sigma_1 \subset \del_+ I_{13} \times (\Sigma - D^2)$ corresponds with a given arc in $\Sigma_4 \subset \del_- I_{13} \times (\Sigma - D^2)$ under the natural identification of $\del_- I_{13} \times (\Sigma - D^2) \cong \del_+ I_{13} \times (\Sigma - D^2)$ induced by $I_{13} \times (\Sigma - D^2)$.  Again let $\theta_{ij}$ be the angle halfway between $\theta_i$ and $\theta_j$, lying in the smaller ($< \pi$) angular region between them.
...
\item Let $c_1,\cdots,c_{2g}$ be a set of disjoint nonseparating arcs in $\Sigma_1$ with their boundaries lying on the puncture of $\Sigma_1$ that is tubed to $\Sigma_4$.
