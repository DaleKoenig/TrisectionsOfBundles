...
Then $\varphi(c_1),\cdots,\varphi(c_{2g})$ is a nonseparating collection of disjoint arcs in $\Sigma_1$ with their boundaries lying on the puncture of $\Sigma_1$ that is tubed to $\Sigma_3$.
